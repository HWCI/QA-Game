    ...
    public void ReplyAnswer(int PlayerAnswerNo)
    {
        ...
        switch (Type)
        {
            case 1:
                 ...
                 * 0 C 崗位 +客戶/資金
                 */
                switch (PlayerAnswerNo)
                {
                    case 1:
                        energyManager.workerEnergy += GameManager.Increase_highestScore;
                        energyManager.qualityEnergy += GameManager.Increase_highestScore;
                        energyManager.EnergyChange();
                        GameManager.ShowTalkingBox(1);
                        
                        break;
                    case 2:
                        if (Random.Range(0, 100) % 2 == 0)
                        {
                            energyManager.workerEnergy += GameManager.Increase_secondScore;
                        }
                        else
                        {
                            energyManager.moneyEnergy += GameManager.Increase_secondScore;
                        }
                        energyManager.EnergyChange();
                        GameManager.ShowTalkingBox(2);
                        break;
                    case 3:
                        if (Random.Range(0, 100) % 2 == 0)
                        {
                            energyManager.clientEnergy -= GameManager.Decrease_secondScore;
                        }
                        else
                        {
                            energyManager.workerEnergy -= GameManager.Decrease_secondScore;
                        }
                        energyManager.EnergyChange();
                        GameManager.ShowTalkingBox(3);
                        break;
                    case 4:
                        energyManager.clientEnergy -= GameManager.Decrease_highestScore;
                        energyManager.qualityEnergy -= GameManager.Decrease_highestScore;
                        energyManager.EnergyChange();
                        GameManager.ShowTalkingBox(4);
                        break;
                    case 5:
                        if (Random.Range(0, 100) % 2 == 0)
                        {
                            energyManager.moneyEnergy -= GameManager.Decrease_secondScore;
                        }
                        else
                        {
                            energyManager.qualityEnergy -= GameManager.Decrease_secondScore;
                        }
                        energyManager.EnergyChange();
                        GameManager.ShowTalkingBox(3);
                        break;
            ...
            case 2:
                ...
                switch (PlayerAnswerNo)
                {
                    case 2://++
                        energyManager.workerEnergy += GameManager.Increase_highestScore;
                        energyManager.moneyEnergy += GameManager.Increase_highestScore;
                        energyManager.EnergyChange();
                        GameManager.ShowTalkingBox(1);
                        break;
                    case 3://+/+
                        if (Random.Range(0, 100) % 2 == 0)
                        {
                            energyManager.clientEnergy += GameManager.Increase_secondScore;
                        }
                        else
                        {
                            energyManager.workerEnergy += GameManager.Increase_secondScore;
                    ...
                    case 4://-/-
                        ...
                        break;
                    case 5://--
                        energyManager.moneyEnergy -= GameManager.Decrease_highestScore;
                        energyManager.qualityEnergy -= GameManager.Decrease_highestScore;
                        energyManager.EnergyChange();
                        GameManager.ShowTalkingBox(4);
                        break;
                    ...
                    case 1:
                        ...
                        {
                            energyManager.qualityEnergy += GameManager.Increase_secondScore;
                        }
                        energyManager.EnergyChange();
                        GameManager.ShowTalkingBox(2);
                        break;
            ...
            case 3:
                ...
                {
                    case 3://++
                        energyManager.clientEnergy += GameManager.Increase_highestScore;
                        energyManager.workerEnergy += GameManager.Increase_highestScore;
                        energyManager.EnergyChange();
                        GameManager.ShowTalkingBox(1);
                        break;
            ...
            case 4:
                ...
                switch (PlayerAnswerNo)
                {
                    ...
                    case 0://-/-
                        ...
                        break;
                    case 1://--
                        energyManager.workerEnergy -= GameManager.Decrease_highestScore;
                        energyManager.qualityEnergy -= GameManager.Decrease_highestScore;
                        energyManager.EnergyChange();
                        GameManager.ShowTalkingBox(4);
                        break;
